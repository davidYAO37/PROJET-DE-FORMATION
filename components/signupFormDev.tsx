  ...
  return (
    <div className="container mt-4">
      <form onSubmit={handleSubmit} className="  rounded bg-light">
        <h3 className="text-center mb-3">Nouveau compte Administrateur</h3>
        ...
        <button type="submit" className="btn btn-primary w-100">Ajouter l'administrateur</button>
      </form>
    </div>
  );
};

export default SignupFormDev;
