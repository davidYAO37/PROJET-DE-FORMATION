              ...
              <Card.Body className={styles.medecinsList}>
                {medecins.length === 0 ? (
                  <div className="text-center text-muted py-3">
                    ...
                    <p className="mb-0 mt-2">Aucun médecin trouvé</p>
                  </div>
                ) : (
                  medecins.map((medecin) => (
                    <div
                      key={medecin._id.toString()}
                      className={`${styles.medecinItem} ${selectedMedecin === medecin._id.toString() ? styles.selected : ''}`}
                      onClick={() => setSelectedMedecin(medecin._id.toString())}
                    >
                      ...
                      {selectedMedecin === medecin._id.toString() && (
