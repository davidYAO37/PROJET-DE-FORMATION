...
export default function PaiementInfoCaisseManuelle({
    formData,
    setFormData,
    modePaiement,
    setModePaiement,
    ...
    const provision = useProvisionPatient(formData.patientId);
    const cautionDisponible = isCautionAvailable(provision, formData.TotalapayerPatient || 0);
