...
import PharmacieCaisseModal from "./PharmacieCaisseModal";

export default function PharmacieCaisse() {
    ...
    return (
        <Container fluid className="p-4">
            <div className="text-center mb-4">
                <h2 className="text-primary mb-4">CAISSE PHARMACIE</h2>
                ...
                <Col md={10}>
                    <Card className="shadow-sm mb-4">
                        <Card.Body className="text-center p-5">
                            ...
                            <h4 className="mb-3">Bienvenue à la caisse pharmacie</h4>
