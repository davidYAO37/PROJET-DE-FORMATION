...
interface PrintFactureDetailléAssuranceProps {
    consultation: any;
}

const PrintFactureDetailléAssurance = forwardRef<HTMLDivElement, PrintFactureDetailléAssuranceProps>(
    ({ consultation }, ref) => {
        return (
            <div ref={ref} id="print-content" style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
                <div style={{ textAlign: 'center', marginBottom: '20px' }}>
                    <h2>Facture Détaillée - Assurance</h2>
                </div>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '20px' }}>
                    ...
                    <tbody>
                        <tr>
                            <td style={{ border: '1px solid #dee2e6', padding: '8px' }}>{consultation?.designationC || 'Consultation détaillée'}</td>
...
PrintFactureDetailléAssurance.displayName = 'PrintFactureDetailléAssurance';

export default PrintFactureDetailléAssurance;