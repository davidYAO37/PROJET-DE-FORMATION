...
interface PrintFactureDetailleAssuranceProps {
    consultation: any;
}
...
const PrintFactureDetailleAssurance = forwardRef<HTMLDivElement, PrintFactureDetailleAssuranceProps>(
    ({ consultation }, ref) => {
        ...
        const handlePrint = () => {
            ...
            createPrintWindow('Facture Détaillée Assurance', headerHTML, restContent, footerHTML);
        };
        ...
        const handlePrintWithoutHeader = () => {
            ...
            createPrintWindowWithoutHeader('Facture Détaillée Assurance (sans entête)', restContent);
        };
            ...
            <>
                ...
                <div ref={ref} id="print-content" style={{ 
                                ...
                                <table style={{ width: '100%', borderCollapse: 'collapse', margin: '0' }}>
                                    ...
                                    <tfoot>
                                        <tr style={{ backgroundColor: '#f8f9fa', fontWeight: 'bold' }}>
                                            <td colSpan={3} style={{ border: '1px solid #dee2e6', padding: '8px', textAlign: 'right', fontSize: '11px' }}>Total Assurance:</td>
                                            <td style={{ border: '1px solid #dee2e6', padding: '8px', textAlign: 'right', fontSize: '11px' }}>
                                                {consultation.consultation?.PartAssurance || '0'} FCFA
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
                    ...
                    <div style={{ 
                        ...
                        <div style={{ fontSize: '10px', color: '#6c757d', marginBottom: '5px' }}>ARRÊTÉ DE FACTURE DÉTAILLÉE ASSURANCE</div>
                        <div style={{ fontSize: '12px', fontWeight: 'bold', color: '#2c3e50', fontStyle: 'italic' }}>
                            La somme de: {NumberToLetter(TotalPartAssurance)} FRANCS CFA
                        </div>
                    </div>
...
PrintFactureDetailleAssurance.displayName = 'PrintFactureDetailleAssurance';

export default PrintFactureDetailleAssurance;
