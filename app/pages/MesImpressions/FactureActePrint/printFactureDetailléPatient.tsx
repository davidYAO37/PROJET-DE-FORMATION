...
interface PrintFactureDetailléPatientProps {
    consultation: any;
}

const PrintFactureDetailléPatient = forwardRef<HTMLDivElement, PrintFactureDetailléPatientProps>(
    ({ consultation }, ref) => {
        return (
            <div ref={ref} id="print-content" style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
                <div style={{ textAlign: 'center', marginBottom: '20px' }}>
                    <h2>Facture Détaillée - Patient</h2>
                </div>
...
PrintFactureDetailléPatient.displayName = 'PrintFactureDetailléPatient';

export default PrintFactureDetailléPatient;