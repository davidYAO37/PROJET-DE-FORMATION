...
const PrintFactureExamenPatient = forwardRef<HTMLDivElement, PrintFactureExamenPatientProps>(
    ({ consultation }, ref) => {
...
PrintFactureExamenPatient.displayName = 'PrintFactureExamenPatient';

export default PrintFactureExamenPatient;