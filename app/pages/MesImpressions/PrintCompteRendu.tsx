...
interface PrintCompteRenduProps {
    donnees: {
        Nompatient: string;
        Sexe?: string;
        Age_partient?: string;
...
const PrintCompteRendu = forwardRef<HTMLDivElement, PrintCompteRenduProps>(
    ({ donnees, validationInfo, autoPrint }, ref) => {
        ...
        const handlePrintWithoutHeader = useCallback(() => {
            const printContent = document.getElementById('print-content');
            if (!printContent) {
                console.error('Contenu d\'impression non trouvé');
                return;
                   ...
                   <div style={{ 
                    ...
                    {validationInfo?.validePar && (
                        <div style={{
                            ...
                            <strong>Validé par :</strong> {validationInfo.validePar}
                            {validationInfo.valideLe && ` le ${validationInfo.valideLe}`}
                        </div>
                    )}
...
PrintCompteRendu.displayName = 'PrintCompteRendu';

export default PrintCompteRendu;
