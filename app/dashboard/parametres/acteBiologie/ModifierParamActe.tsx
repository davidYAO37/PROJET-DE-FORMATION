    ...
    useEffect(() => {
        if (ActeParamLabo) {
            setForm({
                ...
                ValeurMinNormale: ActeParamLabo.ValeurMinNormale || 0,
                ValeurMaxNormale: ActeParamLabo.ValeurMaxNormale || 0,
                ...
                PlageRefMaxNé: ActeParamLabo.PlageRefMaxNé || 0,
                PlageRefMinNe: ActeParamLabo.PlageRefMinNe || 0,
