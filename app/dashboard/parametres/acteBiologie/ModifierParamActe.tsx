"use client";
import { ActeParamLabo } from "@/types/ActeParamLabo";
...
type Props = {
    show: boolean;
    onHide: () => void;
    ActeParamLabo: ActeParamLabo | null;
    onSave: (param: ActeParamLabo) => void;
};

export default function ModifierParamActe({ show, onHide, ActeParamLabo, onSave }: Props) {
    const [form, setForm] = useState({
        ...
        Param_designation: "",
        ParamAbrege: "",
        PlageRefMaxNé: null as number | null,
        PlageRefMinNe: null as number | null,
        PlageMinMaxNé: "",
        PlageMinEnfant: null as number | null,
        PlageMaxEnfant: null as number | null,
        PlageMinMaxEnfant: "",
        PLageMinFemme: null as number | null,
        PlageMaxFemme: null as number | null,
        PlageMinMaxFemme: "",
        PlageMinHomme: null as number | null,
        PlageMaxHomme: null as number | null,
        PlageMinMaxHomme: "",
        UnitéParam: "",
        TypeTexte: false,
    ...
    useEffect(() => {
        if (ActeParamLabo) {
            setForm({
                IDACTEP: ActeParamLabo.IDACTEP || "",
                IDPARAM_LABO: ActeParamLabo.IDPARAM_LABO || "",
                ValeurMinNormale: ActeParamLabo.ValeurMinNormale ?? null,
                ValeurMaxNormale: ActeParamLabo.ValeurMaxNormale ?? null,
                ValeurNormale: ActeParamLabo.ValeurNormale || "",
                Param_designation: ActeParamLabo.Param_designation || "",
                ParamAbrege: ActeParamLabo.ParamAbrege || "",
                PlageRefMaxNé: ActeParamLabo.PlageRefMaxNé ?? null,
                PlageRefMinNe: ActeParamLabo.PlageRefMinNe ?? null,
                PlageMinMaxNé: ActeParamLabo.PlageMinMaxNé || "",
                PlageMinEnfant: ActeParamLabo.PlageMinEnfant || 0,
                PlageMaxEnfant: ActeParamLabo.PlageMaxEnfant || 0,
                PlageMinMaxEnfant: ActeParamLabo.PlageMinMaxEnfant || "",
                PLageMinFemme: ActeParamLabo.PLageMinFemme || 0,
                PlageMaxFemme: ActeParamLabo.PlageMaxFemme || 0,
                PlageMinMaxFemme: ActeParamLabo.PlageMinMaxFemme || "",
                PlageMinHomme: ActeParamLabo.PlageMinHomme || 0,
                PlageMaxHomme: ActeParamLabo.PlageMaxHomme || 0,
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
        ...
        if (type === "checkbox") {
            ...
            // Logique pour les plages Nouveau Né
            ...
            // Logique pour les plages Enfant
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch(`/api/acteparamlabo?id=${ActeParamLabo._id}`, {
                method: "PUT",
            ...
            const data: ActeParamLabo = await res.json();
            onSave(data);
        ...
        <Modal show={show} onHide={onHide} size="xl">
            <Modal.Header closeButton className="bg-primary text-white">
                <Modal.Title>
                    ...
                    Modifier le Paramètre de l'Acte
                </Modal.Title>
            </Modal.Header>
