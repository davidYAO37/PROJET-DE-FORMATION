...
export async function PUT(req: NextRequest) {
    ...
    try {
        ...
        const consultation = await Consultation.findOne({ Code_Prestation: codePrestation });
        ...
        const consultationUpdated = await Consultation.findOne({ Code_Prestation: codePrestation });
