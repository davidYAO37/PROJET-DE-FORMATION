...
export async function PUT(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
    ...
    try {
        ...
        console.log("🔄 PUT /api/patientprescription/[id] - ID:", id, "Body:", body);
        ...
        console.error("Erreur PUT /api/patientprescription/[id]:", error);
        return NextResponse.json({
...
export async function DELETE(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
    ...
    try {
        ...
        console.log("🗑️ DELETE /api/patientprescription/[id] - ID:", id);
        ...
        console.error("Erreur DELETE /api/patientprescription/[id]:", error);
        return NextResponse.json({
